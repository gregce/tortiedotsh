...
const productNotes = {
  ...
  "junie-ide": "Junie's current JetBrains IDE documentation establishes its exact host family, agent panel, local tool execution, MCP, approvals, review flow, and model choices without inheriting Junie CLI worktree or CI behavior.",
