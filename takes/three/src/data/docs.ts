...
export const docsNavGroups: DocsNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        searchTerms: "what is tortie who for coding agent workspace terminal ide tmux supervisor orchestration",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Configure agents, launch defaults, appearance, scrollback, machines, capture, and diagnostics.",
        searchTerms: "preferences command comma general agents keyboard hotkeys appearance font contrast scrollback specstory diagnostics",
      },
      {
...
export const docsPages: DocPage[] = [
  ...
  },
  {
    ...
    title: "Settings and customization",
    description: "Configure Tortie's agents, launch behavior, appearance, scrollback, machines, capture, summaries, and diagnostics.",
