...
export const comparisonProducts: readonly ComparisonProduct[] = [
  ...
  product({
    ...
    tags: ["desktop", "chatgpt", "codex", "parallel-projects", "long-running-work", "review"], platform: ["macos", "windows", "linux"], platformNote: "This is the current ChatGPT desktop app, which includes ChatGPT and Codex modes. Codex CLI, the IDE extension, and Codex cloud remain separate SKUs.", source: "proprietary", execution: ["local-process", "vendor-cloud"], status: "active",
    claims: {
  ...
  product({ id: "codewhale", name: "CodeWhale", categoryId: "coding-agent-harnesses", editorialOrder: 20, officialUrl: "https://github.com/Hmbown/CodeWhale", repository: repo("Hmbown/CodeWhale"), repoMetricId: "codewhale", tags: ["cli", "multi-model", "resume", "oss"], source: "open-source", execution: ["local-process"], status: "active", claims: {
