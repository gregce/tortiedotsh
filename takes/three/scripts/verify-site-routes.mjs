...
console.log(`Site routes verified: ${sitePages.length} shared headers, atomic navigation, canonical comparison redirects, hero copy, responsive product still, stable closing actions, and persistent comparison controls.`);
